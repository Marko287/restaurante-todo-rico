    ...
    <div id="app">
        ...
        <header class="site-header">
            <div class="container-fluid" style="padding-left: 40px;">
                ...
                <a href="#" class="site-logo" style="height: 100%; max-height: 65px; width: 50px;">
                    <img style="width: 200%; object-fit: cover;" src="../../img/WhatsApp_Image_2024-06-20_at_11.55.11-removebg-preview.png" alt="">
                </a>

                <button id="show-hide-sidebar-toggle" style="margin-left: 80px;" class="show-hide-sidebar">
                        ...
                        <div class="site-header-shown">
                            ...
                            <div class="dropdown user-menu">
                                ...
                                <div class="dropdown-menu dropdown-menu-right pt-0" aria-labelledby="dd-user-menu">
                                    ...
                                    <h6 class="p-2 text-center bg-primary">
                                    ...
                                    <a class="dropdown-item" href="./login/cerrar.php">
                                        <form action="./login/cerrar.php" method="post">
                                            <button type="submit" name="salir" style="border: none;">
